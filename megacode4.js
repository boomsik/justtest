...
const processChannelPosts = async () => {
    ...
    const destinationChannelUsername = "your_destination_channel"; // замените на имя канала, куда нужно пересылать сообщения

    const addresses = await getChannelPosts(sourceChannelUsername);
